...
def main():
    # 设置参数
    model_path = '../../train/weights/best.kmodel'  # 这个路径是正确的
    image_path = '../../data_test/00f8c61f8eb5064b1156587431.jpg'  # 使用data_test中的图像
    input_width = 320
    input_height=320
    conf_threshold = 0.25
    iou_threshold = 0.45
    # 加载类别名称（根据你的数据集修改）
    class_names = ['no_defect', 'hole', 'stain', 'three_strands', 'knot', 'flower_jump',
